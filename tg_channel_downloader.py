...
bot_token = '1101108682:AAGZ3cbe1iyfylmvCRSfNUxUS-p63T_hiBo'   # 用于发送消息。 必填
admin_id = 827963305                                           # 你自己的telegram用户ID  可以使用@get_id_bot 找到
upload_file_set = False                                        # 是否上传GD
maximum_seconds_per_download = 1500                            # 超时时间 可选
filter_list = ['© [爱莲阁-恋足丝袜爱好交流](https://t.me/ifoots)',
               '[© 爱莲阁-恋足丝袜爱好交流](https://t.me/ifoots)',
               '\n']                                           # 文件名过滤 可选
#--------------------------------------------------------------------------------------------------------------------#
